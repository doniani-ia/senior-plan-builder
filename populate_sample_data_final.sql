-- Script final para popular dados de exemplo
-- Execute este script no SQL Editor do Supabase Dashboard

-- 1. Inserir questionário (sem created_by por enquanto)
...
-- 5. Atualizar created_by se houver um admin
UPDATE public.questionarios 
SET created_by = (SELECT id FROM public.profiles WHERE papel = 'admin' LIMIT 1)
...
-- 7. Mostrar perguntas por categoria
SELECT 
  p.categoria,
  COUNT(*) as total,
  AVG(p.peso) as peso_medio
