-- Script final que funciona com as constraints existentes
-- Execute este script no SQL Editor do Supabase Dashboard

-- 1. Primeiro, vamos verificar se existe algum usuário admin
DO $$
DECLARE
  admin_id UUID;
BEGIN
  ...
  -- Se ainda não encontrar nenhum usuário, criar um questionário com status 'rascunho'
  IF admin_id IS NULL THEN
    -- Inserir questionário como rascunho (que pode ter created_by NULL)
  ...
  ELSE
    -- Inserir questionário com o admin encontrado
...
-- 3. Mostrar perguntas por categoria
SELECT 
  p.categoria,
  COUNT(*) as total,
  AVG(p.peso) as peso_medio
